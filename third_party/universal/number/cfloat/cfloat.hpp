...
////////////////////////////////////////////////////////////////////////////////////////
// enable/disable the ability to use literals in binary logic and arithmetic
// operators
...
void ShowRepresentations(std::ostream &ostr, float f) {
  ...
  constexpr int max_digits10 =
      std::numeric_limits<Scalar>::max_digits10; // floating-point attribute for
                                                 // printing scientific format
