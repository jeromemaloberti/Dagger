...
inline void extractFields(float value, bool &s, uint64_t &rawExponentBits,
                          uint64_t &rawFractionBits) noexcept {
...
inline void extractFields(double value, bool &s, uint64_t &rawExponentBits,
                          uint64_t &rawFractionBits) noexcept {
...
// generate a color coded binary string for a native single precision IEEE
// floating point
...
inline std::tuple<bool, int, std::uint32_t> ieee_components(float fp) {
  ...
  static_assert(sizeof(float) == 4,
                "This function only works when float is 32 bit.");
  ...
  return std::make_tuple<bool, int, std::uint32_t>(
      static_cast<bool>(fd.parts.sign), static_cast<int>(fd.parts.exponent),
...
inline std::tuple<bool, int, std::uint64_t> ieee_components(double fp) {
  ...
  static_assert(sizeof(double) == 8,
                "This function only works when double is 64 bit.");
