#pragma once
// gcc_long_double.hpp: nonconstexpr implementation of IEEE-754 long double
// manipulators
//
...
/*
 * In contrast to the single and double-precision formats, this format does not
 * utilize an implicit/hidden bit. Rather, bit 63 contains the integer part of
 * the significand and bits 62-0 hold the fractional part. Bit 63 will be 1 on
 * all normalized numbers.
 */
