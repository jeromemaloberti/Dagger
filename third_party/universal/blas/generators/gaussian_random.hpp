...
vector<Scalar> gaussian_random_vector(unsigned N, double mean = 100.00,
                                      double stddev = 6.00) {
  vector<Scalar> v(N);
...
template <typename Scalar>
inline vector<Scalar> &gaussian_random(vector<Scalar> &omega,
                                       double mean = 100.00,
                                       double stddev = 6.00) {
...
template <typename Scalar>
matrix<Scalar> gaussian_random_matrix(unsigned M, unsigned N,
                                      double mean = 100.00,
                                      double stddev = 6.00) {
  matrix<Scalar> A(M, N);
...
template <typename Scalar>
inline matrix<Scalar> gaussian_random(matrix<Scalar> &omega,
                                      double mean = 100.00,
                                      double stddev = 6.00) {
...
// template<typename Scalar>
// inline void gaussian_random(vector<Scalar>& omega, double mean = 100.00,
// double stddev = 6.00){
//     using value_type = typename vector<Scalar>::value_type;
